...
public class FacebookNative extends CustomEventAdView implements AdListener, NativeAdListener {
    ...
    public void onAdLoaded(Ad ad) {
        ...
        if(mFacebookNative != null) {
            ...
            mNativeListener.onAdViewFailed(FluteErrorCode.NO_FILL);
        }
    ...
    public void onError(final Ad ad, final AdError error) {
        Log.d("Flute","Facebook native ad load failed，error : " + error + ", ErrorCode : " + error.getErrorCode() + ", ErrorMessage : " + error.getErrorMessage());
